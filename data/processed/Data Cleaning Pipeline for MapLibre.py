...
from ausmammal_explorer.snapshot import SnapshotFile, build_manifest, write_manifest
...
def fetch_clean_and_format_marsupials(email, output_geojson):
    ...
    write_snapshot_manifest(df, snapshot_files, marsupials)


def write_snapshot_manifest(df, snapshot_files, marsupials):
    ...
    manifest = build_manifest(
        ...
        repo_root=REPO_ROOT,
        notes="Generated by 'Data Cleaning Pipeline for MapLibre.py' for RTM-8/RTM-49.",
    )
